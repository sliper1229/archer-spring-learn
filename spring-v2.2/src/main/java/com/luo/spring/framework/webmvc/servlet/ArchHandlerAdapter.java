 ...
 **/
public class ArchHandlerAdapter {

    public boolean supports(Object handler){ return (handler instanceof ArchHandlerMapping);}


    ArchModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        ArchHandlerMapping handlerMapping = (ArchHandlerMapping)handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == ArchModelAndView.class;
        if(isModelAndView){
            return (ArchModelAndView) result;
        }
        return null;
    }
