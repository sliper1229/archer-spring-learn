...
/**
 * Created by ARCHER on 2019/4/20.
 */
public class JdbcTest {

    public static void main(String[] args) {
        Member condition = new Member();
        condition.setName("ARCHER");
        condition.setAge(19);
    ...
    private static List<?> select(Object condition) {
        ...
        try {
            ...
            //2、建立连接
            con = DriverManager.getConnection("jdbc:mysql://127.0.0" +
                    ".1:3306/demo?characterEncoding=UTF-8&rewriteBatchedStatements=true","root",
                    "1111");
